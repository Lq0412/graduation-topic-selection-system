...
毕业设计选题系统是一套面向高校院系场景的 Web 管理系统，采用前后端分离架构，为学生、教师、系部主任和系统管理员提供不同的业务工作台。
...
| **系部主任** | 审核本系题目、填写打回理由；查看本系选题情况；导出统计结果；在满足条件时切换教师角色参与出题。 |
...
- [主任使用手册](./work-topic-selection-frontend/public/steps/3.主任使用手册.md)
